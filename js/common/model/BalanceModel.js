...
define( function( require ) {
  ...
  function BalanceModel() {
    ...
    thisModel.massList = new ObservableArray( {id: 'massesInModel'} );
    thisModel.userControlledMasses = []; // Masses being controlled by user(s), potentially more than one in touch environment.
    thisModel.columnStateProperty = new Property( 'doubleColumns', {id: 'columnState'} ); // Valid values are doubleColumns, singleColumn, noColumns.
